...
## So, we use the "$" operator to select variables
...
```{webr-r}
print(Reg2 <- lm(Height~MO_Height+FA_Height,data=MSV))
## Regression summary
summary(Reg2)
```
...
**Click [HERE](https://coursesite.lehigh.edu/mod/quiz/view.php?id=5956215){target="_blank"} to submit your answers.**
